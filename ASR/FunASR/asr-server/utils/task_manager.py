...
class TaskManager:
    ...
    def start(self, process_fn):
        """Start background workers and cleanup tasks. process_fn is an async callable(TaskInfo)."""
    ...
    async def submit(self, audio_path: str, identify_speakers: bool = False) -> str:
